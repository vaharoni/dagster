...
class DagsterSlingTranslator:
    ...
    @classmethod
    @public
    def get_metadata(cls, stream_definition: Mapping[str, Any]) -> JsonMetadataValue:
        return MetadataValue.json(stream_definition.get("config", {}))
    ...
    def get_auto_materialize_policy(
        ...
        config = dbt_resource_props.get("config", {}) or {}
        meta = config.get("meta", {})
