...
class DbtCliEventMessage:
    ...
    def to_default_asset_events(
        ...
        metadata = self._process_adapter_response_metadata(adapter_response)
    ...
    def _process_adapter_response_metadata(
        ...
        """
        # Remove the unnecessary metadata from the base AdapterResponse.
        adapter_response.pop("_message", None)
        adapter_response.pop("code", None)

        # Remove the full query output from the Trino AdapterResponse.
        adapter_response.pop("query", None)
        ...
        *,
        ...
        env = {
            **os.environ.copy(),
            ...
            "DBT_LOG_FORMAT": "json",
            # The DBT_LOG_LEVEL environment variable must be set to `debug`. We use this
