...
You've used a schedule to update your data on a regular cadence. However, there are other ways to trigger jobs. For example, sensors can trigger a job after routinely polling a source. Check out the [Automating your pipelines](/guides/dagster/automating-pipelines) guide to learn more.
